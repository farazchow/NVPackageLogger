      ...
      override render() {
        return (
          ...
          <form onSubmit={this.handleSubmit}>
            <label>
              ID: <input type="text" name="id" value={this.state.id} onChange={this.handleChange}/>
            </label>
            <label>
              Resident: <input type="text" name="resident" value={this.state.resident} onChange={this.handleChange}/>
            </label>
            <label>
              Room: <input type="text" name="room" value={this.state.room} onChange={this.handleChange}/>
            </label>
            <label>
              Type: <SelectInput name="type" onChange={this.handleChange} options={["Check-in","Check-out"]}/>
            </label>
